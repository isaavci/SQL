...
SAVEPOINT cilek; -- Olusturdugumuz yeni bir alana database'imizin bir kopyasini koyduk
SAVEPOINT kiraz;
ROLLBACK TO cilek; -- Bu satirda ise yaptigimiz degisiklikleri savepoint cilek durumundaki haline geri dondurduk
ROLLBACK TO kiraz;
